                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        {{-- <form action="{{ route('admin.save-time-table') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label for="subject">Lab Or Lacture</label>
                                <select name="is_lab" id="lab" class="form-control" required>
                                    <option value="0">Lecture</option>
                                    <option value="1">Lab</option>
                                </select>
                            </div>
                            @if ($errors->has('is_lab'))
                                <div class="error">{{ $errors->first('is_lab') }}</div>
                            @endif
                        ...
                        <form action="{{ route('import-timetable') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label for="upload_time_table">Upload Time Table</label>
                                <br>
