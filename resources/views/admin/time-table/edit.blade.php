        ...
        <div class="row">
            <div class="col-xl-12 col-lg-12">
                <div class="card shadow mb-4">
                    <!-- Card Body -->
                    <div class="card-body">
                        <form action="{{ route('admin.update-time-table') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <input type="text" name="timetable" value="{{ $timetable->id }}" style="display: none;">
                            ...
                            <div class="form-group">
                                ...
                                <select name="division_id" id="division"class="form-control" required>
                                    ...
                                    @foreach ($divisions as $division)
                                        @if ($division->id == $timetable->division_id)
                            ...
                            <div class="form-group">
                                ...
                                <select name="faculty_id" id="faculty"class="form-control" required>
                                    ...
                                    @foreach ($faculties as $faculty)
                                        @if ($faculty->id == $timetable->faculty_id)
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group date" id="stimePicker">
                                    <input type="text" id="start_time" class="form-control timePicker" placeholder="Enter Lecture Starting Time" name="start_time" value="{{ $timetable->start_time }}" required>
                            ...
                            @endif
                             ...
                             <div class="form-group">
                                ...
                                <div class="input-group date" id="etimePicker">
                                    <input type="text" class="form-control timePicker" placeholder="Enter Lecture Ending Time" name="end_time" value="{{ $timetable->end_time }}" required>
                                    <span class="input-group-addon">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" placeholder="Enter Term Start Date"
                                    name="term_start_date" value="{{$timetable->term_start_date}}" required>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" placeholder="Enter Term End Date"
                                    name="term_end_date" value="{{$timetable->term_end_date}}" required>
                            </div>
